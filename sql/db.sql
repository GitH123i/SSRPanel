...
CREATE TABLE `user` (
  ...
  `protocol_param` varchar(255) DEFAULT '1' COMMENT '协议参数',
  `obfs` varchar(30) NOT NULL DEFAULT 'plain' COMMENT '混淆',
  `obfs_param` varchar(255) DEFAULT '' COMMENT '混淆参数',
  `speed_limit_per_con` int(255) NOT NULL DEFAULT '304900' COMMENT '单连接限速，默认200M，单位KB',
  `speed_limit_per_user` int(255) NOT NULL DEFAULT '304900' COMMENT '单用户限速，默认200M，单位KB',
...
INSERT INTO `config` VALUES ('30', 'min_port', 20000);
INSERT INTO `config` VALUES ('31', 'max_port', 65535);
